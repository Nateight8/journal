...
export default function JournalTemplateDrawer({
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div
        className={`fixed inset-x-0 bottom-0 z-50 bg-background border-t border-border shadow-2xl transition-transform duration-500 ease-out ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          {/* Footer */}
          <div className="flex-none border-t border-border bg-muted/30 p-4">
