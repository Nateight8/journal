...
function CustomCursor(props: CustomCursorProps) {
  const { pointerEvents, height, points } = props;
  ...
  return (
    <Card className="gap-4 bg-transparent">
      <CardHeader>
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="space-y-0.5">
            <CardTitle>
              <div className="font-bold text-3xl mb-1">Equity Curve</div>
      ...
      <CardContent>
        <ChartContainer
          config={chartConfig}
          className="aspect-auto h-72 w-full [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-chart-1/10 [&_.recharts-rectangle.recharts-tooltip-inner-cursor]:fill-chart-1/25 [&_.recharts-cartesian-grid_line]:stroke-border/30 dark:[&_.recharts-cartesian-grid_line]:stroke-card/30 [&_.recharts-cartesian-axis-line]:stroke-border dark:[&_.recharts-cartesian-axis-line]:stroke-card"
        >
          <LineChart
            accessibilityLayer
            key={selectedValue}
