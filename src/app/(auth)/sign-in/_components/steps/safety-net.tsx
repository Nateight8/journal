...
export function SafetyNetSetup() {
  const {
    setValue,
    watch,
    register,
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-md border border-green-500/20 bg-green-500/5 p-4">
        <div className="flex items-center gap-2">
          ...
          <h4 className="font-medium text-green-500">Risk Management</h4>
        </div>
      ...
      <div className="space-y-6">
        <div className="space-y-3">
          ...
          {errors.maxDailyRisk && (
            <FormError message={errors.maxDailyRisk.message} />
          )}
        </div>
        ...
        <div className="space-y-3">
          ...
          {errors.maxDailyDrawdown && (
            <FormError message={errors.maxDailyDrawdown.message} />
          )}
        </div>
        ...
        <div className="space-y-3">
          ...
          {errors.maxTotalDrawdown && (
            <FormError message={errors.maxTotalDrawdown.message} />
          )}
        </div>
        ...
        <div className="space-y-3">
          ...
          {errors.riskPerTrade && (
            <FormError message={errors.riskPerTrade.message} />
          )}
        </div>
        ...
        <div className="space-y-3">
          ...
          {errors.maxOpenTrades && (
            <FormError message={errors.maxOpenTrades.message} />
          )}
        </div>
      </div>

      {watch("intent")?.includes("propFirmChallenge") && (
