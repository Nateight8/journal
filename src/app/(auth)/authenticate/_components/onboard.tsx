...
import { AccountProfile } from "./steps/account-setup/account-profile";
import { GoalSetting } from "./steps/account-setup/goal-setting";
...
export function Onboard() {
  ...
  const [step, setStep] = React.useState(1); // Update this if you add more steps
                    ...
                    <div className="rounded-lg bg-primary/10 p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="font-medium text-primary">
                          {form.watch("goals")?.[0] || "Not selected"}
                        </span>
                      </div>
                    </div>
